...
object TarotDatabase {
    ...
    val majorArcana = listOf(
        TarotCard(0, "Deli", "Major", meaningUpright = "Yeni başlangıçlar, macera, saf potansiyel, özgürlük, sezgi",
            ...
            keywords = listOf("Başlangıç", "Macera", "Özgürlük"), emoji = "0"),
        TarotCard(1, "Büyücü", "Major", meaningUpright = "Güç, beceri, irade, kaynaklar, manifestasyon",
            ...
            keywords = listOf("Güç", "Beceri", "Yaratma"), emoji = "I"),
        TarotCard(2, "Yüksek Rahibe", "Major", meaningUpright = "Sezgi, bilinçdışı, iç bilgelik, sır, sabır",
            ...
            keywords = listOf("Sezgi", "Bilgelik", "Sır"), emoji = "II"),
        TarotCard(3, "İmparatoriçe", "Major", meaningUpright = "Bolluk, doğurganlık, güzellik, doğa, annelik",
            ...
            keywords = listOf("Bolluk", "Doğa", "Güzellik"), emoji = "III"),
        TarotCard(4, "İmparator", "Major", meaningUpright = "Otorite, düzen, baba figürü, liderlik, koruma",
            ...
            keywords = listOf("Otorite", "Düzen", "Güç"), emoji = "IV"),
        TarotCard(5, "Hierophant", "Major", meaningUpright = "Gelenek, din, öğretim, uygunluk, kurumlar",
            ...
            keywords = listOf("Gelenek", "Öğretim", "İnanç"), emoji = "V"),
        TarotCard(6, "Aşıklar", "Major", meaningUpright = "Sevgi, uyum, değerler, seçimler, birliktelik",
            ...
            keywords = listOf("Sevgi", "Seçim", "Bağlantı"), emoji = "VI"),
        ...
        TarotCard(9, "Ermiş", "Major", meaningUpright = "İç yolculuk, rehberlik, yalnızlık, meditasyon",
            ...
            keywords = listOf("İçe bakış", "Rehberlik", "Yalnızlık"), emoji = "IX"),
        TarotCard(10, "Kader Çarkı", "Major", meaningUpright = "Kader, dönüm noktası, şans, döngüler, fırsatlar",
            ...
            keywords = listOf("Kader", "Döngü", "Şans"), emoji = "X"),
        TarotCard(11, "Adalet", "Major", meaningUpright = "Denge, doğruluk, hukuk, adalet, nedensellik",
            ...
            keywords = listOf("Adalet", "Denge", "Gerçek"), emoji = "XI"),
        TarotCard(12, "Asılan Adam", "Major", meaningUpright = "Bekleyiş, teslim olma, iç aydınlanma, kurban",
            ...
            keywords = listOf("Bekleme", "Kabul", "Perspektif"), emoji = "XII"),
        TarotCard(13, "Ölüm", "Major", meaningUpright = "Son, değişim, dönüşüm, geçiş, yenilenme",
            ...
            keywords = listOf("Dönüşüm", "Son", "Yenilenme"), emoji = "XIII"),
        TarotCard(14, "Ölçülülük", "Major", meaningUpright = "Denge, sabır, uyum, orta yol, iyileşme",
            ...
            keywords = listOf("Denge", "Uyum", "Sabır"), emoji = "XIV"),
        TarotCard(15, "Şeytan", "Major", meaningUpright = "Bağlar, maddecilik, korkular, gölge benlik",
            ...
            keywords = listOf("Bağlar", "Korku", "Gölge"), emoji = "XV"),
        TarotCard(16, "Kule", "Major", meaningUpright = "Ani değişim, kaos, yıkım, ifşa, aydınlanma",
            ...
            keywords = listOf("Kaos", "Yıkım", "İfşa"), emoji = "XVI"),
        TarotCard(17, "Yıldız", "Major", meaningUpright = "Umut, inanç, ilham, tazelenme, yenileme",
            ...
            keywords = listOf("Umut", "İlham", "İnanç"), emoji = "XVII"),
        TarotCard(18, "Ay", "Major", meaningUpright = "Yanılsama, korku, bilinçdışı, sezgi, belirsizlik",
            ...
            keywords = listOf("Yanılsama", "Sezgi", "Bilinçdışı"), emoji = "XVIII"),
        TarotCard(19, "Güneş", "Major", meaningUpright = "Mutluluk, başarı, neşe, canlılık, aydınlık",
            ...
            keywords = listOf("Mutluluk", "Başarı", "Neşe"), emoji = "XIX"),
        TarotCard(20, "Yargı", "Major", meaningUpright = "Uyanış, yeniden doğuş, değerlendirme, çağrı",
            ...
            keywords = listOf("Uyanış", "Yeniden doğuş", "Değerlendirme"), emoji = "XX"),
        TarotCard(21, "Dünya", "Major", meaningUpright = "Tamamlanma, bütünleşme, başarı, seyahat, bütünlük",
            ...
            keywords = listOf("Tamamlanma", "Başarı", "Bütünlük"), emoji = "XXI")
    )

    // Minor Arcana - Kupalar (Duygular, ilişkiler)
    val minorKupalar = listOf(
        TarotCard(22, "Kupalar Ası", "Minor", "Kupalar", "Yeni duygular, aşk başlangıcı, sezgi, yaratıcılık", "Duygusal blok, boşluk", listOf("Aşk", "Başlangıç", "Sezgi"), "A 🏆"),
        TarotCard(23, "Kupalar İkilisi", "Minor", "Kupalar", "Birlik, ortaklık, karşılıklı çekim, aşk", "Kopukluk, uyumsuzluk", listOf("Ortaklık", "Aşk", "Birlik"), "II 🏆"),
        TarotCard(24, "Kupalar Üçlüsü", "Minor", "Kupalar", "Kutlama, dostluk, yaratıcılık, topluluk", "Bağımlılık, aşırılık", listOf("Kutlama", "Dostluk", "Sevinç"), "III 🏆"),
        TarotCard(25, "Kupalar Dördüsü", "Minor", "Kupalar", "Hayal kırıklığı, ilgisizlik, yeniden değerlendirme", "Fırsatı kaçırma, motivasyon", listOf("Hayal kırıklığı", "Meditasyon", "Dönüş"), "IV 🏆"),
        TarotCard(26, "Kupalar Beşlisi", "Minor", "Kupalar", "Kayıp, hayal kırıklığı, yası tutmak, pişmanlık", "Kabul, ilerlemek, af", listOf("Kayıp", "Yas", "Pişmanlık"), "V 🏆"),
        TarotCard(27, "Kupalar Altılısı", "Minor", "Kupalar", "Nostalji, mutluluk, çocukluk anıları, yeniden kavuşma", "Geçmişte kalmak, gerçekçi olmayan", listOf("Nostalji", "Çocukluk", "Mutluluk"), "VI 🏆"),
        TarotCard(28, "Kupalar Yedilisi", "Minor", "Kupalar", "Seçenekler, hayal kurma, yanılsama, fantezi", "Gerçeklik, netlik, kararlar", listOf("Seçim", "Hayal", "Yanılsama"), "VII 🏆"),
        TarotCard(29, "Kupalar Sekizlisi", "Minor", "Kupalar", "Terk etmek, hayal kırıklığı, yeni yön arama", "Kaçış, bırakamama, umursamazlık", listOf("Bırakmak", "Yön değiştirme", "Arayış"), "VIII 🏆"),
        TarotCard(30, "Kupalar Dokuzlusu", "Minor", "Kupalar", "Dilek kartı, tatmin, refah, mutluluk, şükran", "Tatminsizlik, maddecilik", listOf("Dilek", "Tatmin", "Refah"), "IX 🏆"),
        TarotCard(31, "Kupalar Onlusu", "Minor", "Kupalar", "İdeal mutluluk, aile refahı, doyum, huzur", "Gerçekçi olmayan beklentiler", listOf("Mutluluk", "Aile", "Huzur"), "X 🏆")
    )
